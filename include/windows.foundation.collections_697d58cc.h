...
namespace Windows { namespace Foundation { namespace Collections
{
    ...
    template <class T>
                 struct VectorChangedEventHandler_impl;
    template <class T>
    struct IObservableVector_impl;
    template <class K>
    struct IMapChangedEventArgs_impl;
    template <class K, class V>
    struct MapChangedEventHandler_impl;
    template <class K, class V>
    ...
    namespace Detail
    {
        ...
        inline void _Cleanup(type * , unsigned ) {}
        ...
        template <class T>
        void _Cleanup(T* , unsigned , typename enable_if<!__is_class(T) && !(is_pointer<T>::value)>::type = 0) {}
    ...
    public:
        typedef T T_complex;
        virtual HRESULT STDMETHODCALLTYPE get_Current(_Out_ T_abi *current) = 0;
        virtual HRESULT STDMETHODCALLTYPE get_HasCurrent(_Out_ boolean *hasCurrent) = 0;
    ...
    public:
        ...
        virtual HRESULT STDMETHODCALLTYPE get_Size(_Out_ unsigned *size) = 0;
    ...
    template <class T>
    struct IVectorView_impl<T, false> : IInspectable
    {
    private:
        typedef typename Windows::Foundation::Internal::GetAbiType<T>::type T_abi;
        typedef typename Windows::Foundation::Internal::GetLogicalType<T>::type T_logical;
    ...
    template <class T>
    struct IVector_impl<T, false> : IInspectable
    {
    private:
        typedef typename Windows::Foundation::Internal::GetAbiType<T>::type T_abi;
        typedef typename Windows::Foundation::Internal::GetLogicalType<T>::type T_logical;
    ...
    public:
        ...
        virtual HRESULT STDMETHODCALLTYPE get_Size(_Out_ unsigned int *size) = 0;
...
namespace Windows { namespace Foundation { namespace Collections {
    template <class T>
                 struct VectorChangedEventHandler_impl : IUnknown
    {
    private:
        typedef typename Windows::Foundation::Internal::GetLogicalType<T>::type T_logical;
    public:
    ...
    public:
        typedef T T_complex;
        virtual HRESULT STDMETHODCALLTYPE add_VectorChanged (_In_opt_ VectorChangedEventHandler<T_logical>* handler, _Out_ EventRegistrationToken* token) = 0;
        virtual HRESULT STDMETHODCALLTYPE remove_VectorChanged(_In_ EventRegistrationToken token) = 0;
    };
    template <class K>
    ...
    public:
        typedef K K_complex;
        virtual HRESULT STDMETHODCALLTYPE get_CollectionChange (_Out_ CollectionChange* value) = 0;
        virtual HRESULT STDMETHODCALLTYPE get_Key (_Out_ K_abi* value) = 0;
    };
    template <class K, class V>
                 struct MapChangedEventHandler_impl : IUnknown
    {
    private:
        typedef typename Windows::Foundation::Internal::GetLogicalType<K>::type K_logical;
        typedef typename Windows::Foundation::Internal::GetLogicalType<V>::type V_logical;
    ...
    public:
        typedef K K_complex;
        typedef V V_complex;
        virtual HRESULT STDMETHODCALLTYPE add_MapChanged (_In_opt_ MapChangedEventHandler<K_logical, V_logical>* handler, _Out_ EventRegistrationToken* token) = 0;
        virtual HRESULT STDMETHODCALLTYPE remove_MapChanged(_In_ EventRegistrationToken token) = 0;
    };
}}}
}
