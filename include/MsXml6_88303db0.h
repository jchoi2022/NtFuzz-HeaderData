...
EXTERN_C const IID IID_IXMLHTTPRequest2;
    typedef struct IXMLHTTPRequest2Vtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE *Open )(
            __RPC__in IXMLHTTPRequest2 * This,
                                    __RPC__in_string const WCHAR *pwszMethod,
                                    __RPC__in_string const WCHAR *pwszUrl,
                       __RPC__in_opt IXMLHTTPRequest2Callback *pStatusCallback,
                                       __RPC__in_opt_string const WCHAR *pwszUserName,
                                       __RPC__in_opt_string const WCHAR *pwszPassword,
                                       __RPC__in_opt_string const WCHAR *pwszProxyUserName,
                                       __RPC__in_opt_string const WCHAR *pwszProxyPassword);
        HRESULT ( STDMETHODCALLTYPE *Send )(
            __RPC__in IXMLHTTPRequest2 * This,
                               __RPC__in_opt ISequentialStream *pBody,
                       ULONGLONG cbBody);
        HRESULT ( STDMETHODCALLTYPE *Abort )(
            __RPC__in IXMLHTTPRequest2 * This);
        HRESULT ( STDMETHODCALLTYPE *SetCookie )(
            __RPC__in IXMLHTTPRequest2 * This,
                            __RPC__in const XHR_COOKIE *pCookie,
                        __RPC__out DWORD *pdwCookieState);
        HRESULT ( STDMETHODCALLTYPE *SetCustomResponseStream )(
            __RPC__in IXMLHTTPRequest2 * This,
                       __RPC__in_opt ISequentialStream *pSequentialStream);
        HRESULT ( STDMETHODCALLTYPE *SetProperty )(
            __RPC__in IXMLHTTPRequest2 * This,
        ...
        HRESULT ( STDMETHODCALLTYPE *SetRequestHeader )(
            __RPC__in IXMLHTTPRequest2 * This,
                                    __RPC__in_string const WCHAR *pwszHeader,
                                       __RPC__in_opt_string const WCHAR *pwszValue);
        HRESULT ( STDMETHODCALLTYPE *GetAllResponseHeaders )(
            __RPC__in IXMLHTTPRequest2 * This,
                                __RPC__deref_out_opt_string WCHAR **ppwszHeaders);
        HRESULT ( STDMETHODCALLTYPE *GetCookie )(
            __RPC__in IXMLHTTPRequest2 * This,
                                    __RPC__in_string const WCHAR *pwszUrl,
                                       __RPC__in_opt_string const WCHAR *pwszName,
                       DWORD dwFlags,
                        __RPC__out ULONG *pcCookies,
                                          __RPC__deref_out_ecount_full_opt(*pcCookies) XHR_COOKIE **ppCookies);
        HRESULT ( STDMETHODCALLTYPE *GetResponseHeader )(
            __RPC__in IXMLHTTPRequest2 * This,
                                    __RPC__in_string const WCHAR *pwszHeader,
                                __RPC__deref_out_opt_string WCHAR **ppwszValue);
        END_INTERFACE
        ...
        HRESULT ( STDMETHODCALLTYPE *OnServerCertificateReceived )(
            __RPC__in IXMLHTTPRequest3Callback * This,
                       ...
                       DWORD cServerCertificateChain,
                                        __RPC__in_ecount_full_opt(cServerCertificateChain) const XHR_CERT *rgServerCertificateChain);
        ...
        HRESULT ( STDMETHODCALLTYPE *SetClientCertificate )(
            __RPC__in IXMLHTTPRequest3 * This,
                       DWORD cbClientCertificateHash,
                                        __RPC__in_ecount_full_opt(cbClientCertificateHash) const BYTE *pbClientCertificateHash,
                                       __RPC__in_opt_string const WCHAR *pwszPin);
        END_INTERFACE
