...
template <> struct guid_storage<Windows::ApplicationModel::Search::ILocalContentSuggestionSettings>{ static constexpr guid value{ 0xEEAEB062,0x743D,0x456E,{ 0x84,0xA3,0x23,0xF0,0x6F,0x2D,0x15,0xD7 } }; };
template <> struct guid_storage<Windows::ApplicationModel::Search::ISearchPane>{ static constexpr guid value{ 0xFDACEC38,0x3700,0x4D73,{ 0x91,0xA1,0x2F,0x99,0x86,0x74,0x23,0x8A } }; };
template <> struct guid_storage<Windows::ApplicationModel::Search::ISearchPaneQueryChangedEventArgs>{ static constexpr guid value{ 0x3C064FE9,0x2351,0x4248,{ 0xA5,0x29,0x71,0x10,0xF4,0x64,0xA7,0x85 } }; };
template <> struct guid_storage<Windows::ApplicationModel::Search::ISearchPaneQueryLinguisticDetails>{ static constexpr guid value{ 0x82FB460E,0x0940,0x4B6D,{ 0xB8,0xD0,0x64,0x2B,0x30,0x98,0x9E,0x15 } }; };
template <> struct guid_storage<Windows::ApplicationModel::Search::ISearchPaneQuerySubmittedEventArgs>{ static constexpr guid value{ 0x143BA4FC,0xE9C5,0x4736,{ 0x91,0xB2,0xE8,0xEB,0x9C,0xB8,0x83,0x56 } }; };
template <> struct guid_storage<Windows::ApplicationModel::Search::ISearchPaneQuerySubmittedEventArgsWithLinguisticDetails>{ static constexpr guid value{ 0x460C92E5,0x4C32,0x4538,{ 0xA4,0xD4,0xB6,0xB4,0x40,0x0D,0x14,0x0F } }; };
template <> struct guid_storage<Windows::ApplicationModel::Search::ISearchPaneResultSuggestionChosenEventArgs>{ static constexpr guid value{ 0xC8316CC0,0xAED2,0x41E0,{ 0xBC,0xE0,0xC2,0x6C,0xA7,0x4F,0x85,0xEC } }; };
template <> struct guid_storage<Windows::ApplicationModel::Search::ISearchPaneStatics>{ static constexpr guid value{ 0x9572ADF1,0x8F1D,0x481F,{ 0xA1,0x5B,0xC6,0x16,0x55,0xF1,0x6A,0x0E } }; };
template <> struct guid_storage<Windows::ApplicationModel::Search::ISearchPaneStaticsWithHideThisApplication>{ static constexpr guid value{ 0x00732830,0x50F1,0x4D03,{ 0x99,0xAC,0xC6,0x64,0x4C,0x8E,0xD8,0xB5 } }; };
template <> struct guid_storage<Windows::ApplicationModel::Search::ISearchPaneSuggestionsRequest>{ static constexpr guid value{ 0x81B10B1C,0xE561,0x4093,{ 0x9B,0x4D,0x2A,0xD4,0x82,0x79,0x4A,0x53 } }; };
template <> struct guid_storage<Windows::ApplicationModel::Search::ISearchPaneSuggestionsRequestDeferral>{ static constexpr guid value{ 0xA0D009F7,0x8748,0x4EE2,{ 0xAD,0x44,0xAF,0xA6,0xBE,0x99,0x7C,0x51 } }; };
template <> struct guid_storage<Windows::ApplicationModel::Search::ISearchPaneSuggestionsRequestedEventArgs>{ static constexpr guid value{ 0xC89B8A2F,0xAC56,0x4460,{ 0x8D,0x2F,0x80,0x02,0x3B,0xEC,0x4F,0xC5 } }; };
template <> struct guid_storage<Windows::ApplicationModel::Search::ISearchPaneVisibilityChangedEventArgs>{ static constexpr guid value{ 0x3C4D3046,0xAC4B,0x49F2,{ 0x97,0xD6,0x02,0x0E,0x61,0x82,0xCB,0x9C } }; };
template <> struct guid_storage<Windows::ApplicationModel::Search::ISearchQueryLinguisticDetails>{ static constexpr guid value{ 0x46A1205B,0x69C9,0x4745,{ 0xB7,0x2F,0xA8,0xA4,0xFC,0x8F,0x24,0xAE } }; };
template <> struct guid_storage<Windows::ApplicationModel::Search::ISearchQueryLinguisticDetailsFactory>{ static constexpr guid value{ 0xCAC6C3B8,0x3C64,0x4DFD,{ 0xAD,0x9F,0x47,0x9E,0x4D,0x40,0x65,0xA4 } }; };
template <> struct guid_storage<Windows::ApplicationModel::Search::ISearchSuggestionCollection>{ static constexpr guid value{ 0x323A8A4B,0xFBEA,0x4446,{ 0xAB,0xBC,0x3D,0xA7,0x91,0x5F,0xDD,0x3A } }; };
template <> struct guid_storage<Windows::ApplicationModel::Search::ISearchSuggestionsRequest>{ static constexpr guid value{ 0x4E4E26A7,0x44E5,0x4039,{ 0x90,0x99,0x60,0x00,0xEA,0xD1,0xF0,0xC6 } }; };
template <> struct guid_storage<Windows::ApplicationModel::Search::ISearchSuggestionsRequestDeferral>{ static constexpr guid value{ 0xB71598A9,0xC065,0x456D,{ 0xA8,0x45,0x1E,0xCC,0xEC,0x5D,0xC2,0x8B } }; };
...
template <> struct abi<Windows::ApplicationModel::Search::ILocalContentSuggestionSettings>{ struct type : IInspectable
{
    ...
    virtual int32_t WINRT_CALL put_AqsFilter(void* value) noexcept = 0;
    virtual int32_t WINRT_CALL get_AqsFilter(void** value) noexcept = 0;
    virtual int32_t WINRT_CALL get_PropertiesToMatch(void** value) noexcept = 0;
};};
template <> struct abi<Windows::ApplicationModel::Search::ISearchPane>{ struct type : IInspectable
{
    ...
    virtual int32_t WINRT_CALL add_QueryChanged(void* handler, winrt::event_token* token) noexcept = 0;
    virtual int32_t WINRT_CALL remove_QueryChanged(winrt::event_token token) noexcept = 0;
    ...
    virtual int32_t WINRT_CALL add_QuerySubmitted(void* handler, winrt::event_token* token) noexcept = 0;
    virtual int32_t WINRT_CALL remove_QuerySubmitted(winrt::event_token token) noexcept = 0;
    virtual int32_t WINRT_CALL add_ResultSuggestionChosen(void* handler, winrt::event_token* token) noexcept = 0;
    virtual int32_t WINRT_CALL remove_ResultSuggestionChosen(winrt::event_token token) noexcept = 0;
    ...
    virtual int32_t WINRT_CALL ShowOverloadWithQuery(void* query) noexcept = 0;
    virtual int32_t WINRT_CALL put_ShowOnKeyboardInput(bool value) noexcept = 0;
    virtual int32_t WINRT_CALL get_ShowOnKeyboardInput(bool* value) noexcept = 0;
    virtual int32_t WINRT_CALL TrySetQueryText(void* query, bool* succeeded) noexcept = 0;
};};
...
{
    virtual int32_t WINRT_CALL get_QueryTextAlternatives(void** value) noexcept = 0;
    virtual int32_t WINRT_CALL get_QueryTextCompositionStart(uint32_t* value) noexcept = 0;
    virtual int32_t WINRT_CALL get_QueryTextCompositionLength(uint32_t* value) noexcept = 0;
};};
...
{
    virtual int32_t WINRT_CALL GetForCurrentView(void** searchPane) noexcept = 0;
};};
...
template <> struct abi<Windows::ApplicationModel::Search::ISearchPaneSuggestionsRequest>{ struct type : IInspectable
{
    ...
    virtual int32_t WINRT_CALL get_SearchSuggestionCollection(void** collection) noexcept = 0;
...
{
    virtual int32_t WINRT_CALL CreateInstance(void* queryTextAlternatives, uint32_t queryTextCompositionStart, uint32_t queryTextCompositionLength, void** value) noexcept = 0;
};};
template <> struct abi<Windows::ApplicationModel::Search::ISearchSuggestionCollection>{ struct type : IInspectable
{
    ...
    virtual int32_t WINRT_CALL AppendQuerySuggestion(void* text) noexcept = 0;
    virtual int32_t WINRT_CALL AppendQuerySuggestions(void* suggestions) noexcept = 0;
    virtual int32_t WINRT_CALL AppendResultSuggestion(void* text, void* detailText, void* tag, void* image, void* imageAlternateText) noexcept = 0;
    virtual int32_t WINRT_CALL AppendSearchSeparator(void* label) noexcept = 0;
};};
