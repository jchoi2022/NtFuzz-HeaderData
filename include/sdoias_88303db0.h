...
EXTERN_C const IID IID_ISdoMachine;
    typedef struct ISdoMachineVtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE *GetIDsOfNames )(
            ...
            __RPC__in ISdoMachine * This,
                       __RPC__in BSTR bstrComputerName);
                   HRESULT ( STDMETHODCALLTYPE *GetDictionarySDO )(
            __RPC__in ISdoMachine * This,
                                __RPC__deref_out_opt IUnknown **ppDictionarySDO);
                   HRESULT ( STDMETHODCALLTYPE *GetServiceSDO )(
            __RPC__in ISdoMachine * This,
                       IASDATASTORE eDataStore,
                       __RPC__in BSTR bstrServiceName,
                                __RPC__deref_out_opt IUnknown **ppServiceSDO);
                   HRESULT ( STDMETHODCALLTYPE *GetUserSDO )(
            __RPC__in ISdoMachine * This,
                       IASDATASTORE eDataStore,
                       __RPC__in BSTR bstrUserName,
                                __RPC__deref_out_opt IUnknown **ppUserSDO);
                   HRESULT ( STDMETHODCALLTYPE *GetOSType )(
            __RPC__in ISdoMachine * This,
                                __RPC__out IASOSTYPE *eOSType);
                   HRESULT ( STDMETHODCALLTYPE *GetDomainType )(
            __RPC__in ISdoMachine * This,
                                __RPC__out IASDOMAINTYPE *eDomainType);
                   HRESULT ( STDMETHODCALLTYPE *IsDirectoryAvailable )(
            __RPC__in ISdoMachine * This,
                                __RPC__out VARIANT_BOOL *boolDirectoryAvailable);
                   HRESULT ( STDMETHODCALLTYPE *GetAttachedComputer )(
            __RPC__in ISdoMachine * This,
                                __RPC__deref_out_opt BSTR *bstrComputerName);
                           HRESULT ( STDMETHODCALLTYPE *GetSDOSchema )(
            __RPC__in ISdoMachine * This,
                                __RPC__deref_out_opt IUnknown **ppSDOSchema);
        END_INTERFACE
    } ISdoMachineVtbl;
...
EXTERN_C const IID IID_ISdoMachine2;
    typedef struct ISdoMachine2Vtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE *GetIDsOfNames )(
            ...
            __RPC__in ISdoMachine2 * This,
                                __RPC__deref_out_opt IUnknown **ppSDOSchema);
                   HRESULT ( STDMETHODCALLTYPE *GetTemplatesSDO )(
            __RPC__in ISdoMachine2 * This,
                       __RPC__in BSTR bstrServiceName,
                                __RPC__deref_out_opt IUnknown **ppTemplatesSDO);
                   HRESULT ( STDMETHODCALLTYPE *EnableTemplates )(
            __RPC__in ISdoMachine2 * This);
                   HRESULT ( STDMETHODCALLTYPE *SyncConfigAgainstTemplates )(
            __RPC__in ISdoMachine2 * This,
                       __RPC__in BSTR bstrServiceName,
                            __RPC__deref_inout_opt IUnknown **ppConfigRoot,
                            __RPC__deref_inout_opt IUnknown **ppTemplatesRoot,
                       VARIANT_BOOL bForcedSync);
                   HRESULT ( STDMETHODCALLTYPE *ImportRemoteTemplates )(
            __RPC__in ISdoMachine2 * This,
    ...
    typedef struct ISdoServiceControlVtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE *GetIDsOfNames )(
            ...
            __RPC__in ISdoServiceControl * This,
                   ...
                   HRESULT ( STDMETHODCALLTYPE *ResetService )(
            __RPC__in ISdoServiceControl * This);
        END_INTERFACE
...
EXTERN_C const IID IID_ISdo;
    typedef struct ISdoVtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE *GetIDsOfNames )(
            ...
            __RPC__in ISdo * This,
                       LONG Id,
                                __RPC__deref_out_opt IUnknown **ppPropertyInfo);
            ...
            __RPC__in ISdo * This,
                   ...
                   HRESULT ( STDMETHODCALLTYPE *ResetProperty )(
            __RPC__in ISdo * This,
                       LONG Id);
        ...
        HRESULT ( STDMETHODCALLTYPE *GetIDsOfNames )(
            ...
            __RPC__in ISdoCollection * This,
                       __RPC__in BSTR bstrName,
                            __RPC__deref_inout_opt IDispatch **ppItem);
            ...
            __RPC__in ISdoCollection * This);
                   HRESULT ( STDMETHODCALLTYPE *Reload )(
            __RPC__in ISdoCollection * This);
                   HRESULT ( STDMETHODCALLTYPE *IsNameUnique )(
            __RPC__in ISdoCollection * This,
                       __RPC__in BSTR bstrName,
...
EXTERN_C const IID IID_ITemplateSdo;
    typedef struct ITemplateSdoVtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE *GetIDsOfNames )(
            ...
            __RPC__in ITemplateSdo * This,
                       __RPC__in BSTR bstrName,
                       __RPC__in_opt IDispatch *pCollection,
                            __RPC__deref_inout_opt IDispatch **ppItem);
                   HRESULT ( STDMETHODCALLTYPE *AddToSdo )(
            __RPC__in ITemplateSdo * This,
                       __RPC__in BSTR bstrName,
                       __RPC__in_opt IDispatch *pSdoTarget,
                            __RPC__deref_inout_opt IDispatch **ppItem);
                   HRESULT ( STDMETHODCALLTYPE *AddToSdoAsProperty )(
            __RPC__in ITemplateSdo * This,
                       __RPC__in_opt IDispatch *pSdoTarget,
                       LONG id);
        END_INTERFACE
...
EXTERN_C const IID IID_ISdoDictionaryOld;
    typedef struct ISdoDictionaryOldVtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE *GetIDsOfNames )(
            ...
            __RPC__in ISdoDictionaryOld * This,
                            __RPC__inout VARIANT *Id,
                                __RPC__out VARIANT *pValues);
                           HRESULT ( STDMETHODCALLTYPE *GetAttributeInfo )(
            __RPC__in ISdoDictionaryOld * This,
                       ATTRIBUTEID Id,
                       __RPC__in VARIANT *pInfoIDs,
                                __RPC__out VARIANT *pInfoValues);
                   HRESULT ( STDMETHODCALLTYPE *EnumAttributeValues )(
            __RPC__in ISdoDictionaryOld * This,
                       ATTRIBUTEID Id,
                        __RPC__out VARIANT *pValueIds,
                                __RPC__out VARIANT *pValuesDesc);
                   HRESULT ( STDMETHODCALLTYPE *CreateAttribute )(
            __RPC__in ISdoDictionaryOld * This,
                       ATTRIBUTEID Id,
                                __RPC__deref_out_opt IDispatch **ppAttributeObject);
                   HRESULT ( STDMETHODCALLTYPE *GetAttributeID )(
            __RPC__in ISdoDictionaryOld * This,
                       __RPC__in BSTR bstrAttributeName,
                                __RPC__out ATTRIBUTEID *pId);
        END_INTERFACE
