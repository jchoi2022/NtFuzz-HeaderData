...
STDAPI RatingClickedOnPRFInternal(HWND hWndOwner, HINSTANCE , _In_ LPSTR lpszFileName, int nShow);
STDAPI RatingClickedOnRATInternal(HWND hWndOwner, HINSTANCE , _In_ LPSTR lpszFileName, int nShow);
